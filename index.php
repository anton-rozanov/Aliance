  ...
  <div class="mobile-menu">
    <ul class="mobile-menu-nav">
     ...
     <div class="mobile-info">
      ...
      <a href="mailto:tavermaaa@mail.ru" class="mobile-info-email">
        tavermaaa@mail.ru        
      </a>
     </div>     
     <!-- /.mobile-info -->
...
<!-- /.navbar -->
   ...
   <section class="section production">
    <div class="container"><div class="seporator"></div>
    ...
    <div class="cards">
      ...
      <a  href="#" class="card">
        ...
        <img src="/img/him.png" alt="Бытовая химия" class="card-image">
      </a>
      <a href="#"  class="card">
        <div class="card-content">
      ...
      <a href="#"  class="card">
        ...
        <img src="/img/household.png" alt="Косметическая продукция" class="card-image">
      </a>
      <a href="#"  class="card">
        <div class="card-content">
    ...
    <div class="container">
      <div class="founder-content-wrapper">
        <div class="founder-content">
          ...
          <a href="#" class="button-link">Подробнее о компании</a></li>
        </div>
        <!-- /.founder-content -->
      </div>
          ...
          <ul class="clients-list">
            ...
            <li class="clients-list-item">
              <svg  width="30" height="30"class="clients-list-icon">
               <use href="img/sprite.svg#auto2"></use>
              </svg>
              Автомойки
            </li>
            <li class="clients-list-item">
            ...
            <li class="clients-list-item">
              <svg  width="30" height="30"class="clients-list-icon">
               <use href="img/sprite.svg#autocos6"></use>
              </svg>
      ...
      <div class="footer-top">
        <svg class="logo-svg footer-logo">
         ...
         <div class="footer-info">
          ...
          <a href="mailto:tavermaaa@mail.ru" class="footer-info-email">
            tavermaaa@mail.ru        
          </a>
         </div>     
         <!-- /.footer-info -->
